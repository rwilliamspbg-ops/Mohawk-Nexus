...
- **Demo 2: Efficiency Dashboard** (2-3 hours) ← *Easiest win if pressed for time*
  - Side-by-side resource comparison
  - Water/energy/cost metrics
  - 100k-node benchmark data
  
- **Demo 3: Edge Powerhouse** (3-4 hours)
  - Sub-60MB RAM proof running on Zenbook
  - Wasmhost runtime + WASM agent
  - Tangible "wow" factor
...
- Q&A section (pre-written answers you can adapt)
- Physical demo talking points
- Fallback strategies if something breaks
...
- **Hours 2-3**: Build Demo 1 (full React code included)
- **Hours 3-4**: Build Demo 2 (full React code included)
...
**Best use**: Print it, keep it by your laptop, glance at it if you get nervous or forget something.
...
- Python 3.11+
- Docker
- TinyGo (if doing Demo 3)
- npm/yarn

**Installs if missing**: Guides you to install any missing tools so you don't waste hour 1 of the hackathon.
...
- [ ] Take a screenshot of this README (1 min)
- [ ] Sleep 6+ hours (critical!)
...
❌ **Pitfall 1: Trying to build all 3 demos perfectly**
→ Build 2 demos well instead of 3 badly.

❌ **Pitfall 2: Forgetting to print/memorize the pitch**
→ You'll freeze. Say it out loud now.

❌ **Pitfall 3: Deploying only to localhost**
→ Push to GitHub Pages. Judges might want to explore offline.

❌ **Pitfall 4: Not testing the environment tonight**
→ You'll waste hour 1 installing Go or TinyGo.

❌ **Pitfall 5: Trying to explain Lean4 proofs**
→ Just say "Mathematically proven correct." Judges don't need implementation details.

❌ **Pitfall 6: No backup plan for live demo crashes**
→ Have screenshots ready. A video. Fallback code walkthrough.
...
- [ ] Read this entire directory (main documents)
- [ ] Say your 30-second pitch out loud 5x
- [ ] Run `bash hackathon-prep.sh`
- [ ] Install any missing tools (if needed)
- [ ] Test Docker: `docker ps`
- [ ] Clone/verify Sovereign-Mohawk-Proto reference exists
- [ ] Charge laptop 100%
- [ ] Set alarm for tomorrow
- [ ] Sleep 6+ hours (this is non-negotiable for performance)

---

## 🎤 Your Moment

Hackathons are about **showing the future in 4-6 hours**.

You have a repo that's 90% complete already. Sovereign-Mohawk-Proto exists. The math is proven. The architecture is sound.
...
- **"I'm nervous, give me backup notes"** → [QUICK-REF.md](QUICK-REF.md)
- **"I need to check my toolchain"** → `bash hackathon-prep.sh`
...
- Infrastructure >> UI. You have that advantage.

**Go show them the future of agentic systems.**
